...
public class FadeObjectKoen : MonoBehaviour
{
    [SerializeField]
    private GameObject _objectWithSpritesToInfluence;
    ...
    private void Awake()
    {
        _spriteRenderers = _objectWithSpritesToInfluence.GetComponentsInChildren<SpriteRenderer>();
