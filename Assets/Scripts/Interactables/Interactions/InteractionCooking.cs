...
public class InteractionCooking : Interaction
{
    // PUBLIC
    ...
    IEnumerator Result()
    {
        ...
        vegetableSpawner.enabled = false;
    ...
    // figure out where the bottom functions are being called from (it's not from within this script)
    ...
    public void AttachChefHat()
    {
        ...
        StartCoroutine(DelayDetachment());
    }
    IEnumerator DelayDetachment()
    {
